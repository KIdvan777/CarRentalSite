...
var _ItemHight = __webpack_require__(3);

var _ItemHight2 = _interopRequireDefault(_ItemHight);

var _RevealOnScroll = __webpack_require__(4);

var _RevealOnScroll2 = _interopRequireDefault(_RevealOnScroll);

var _AnimateScroll = __webpack_require__(6);
...
var aniScroll = new _AnimateScroll2.default((0, _jquery2.default)(".vehicles__item"), "left", 5000);
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.menuIconTop = (0, _jquery2.default)(".header__menu-icon__top");
		this.menuIconMiddle = (0, _jquery2.default)(".header__menu-icon__middle");
		this.menuIconBottom = (0, _jquery2.default)(".header__menu-icon__bottom");
...
var ItemHight = function () {
	function ItemHight(item) {
		_classCallCheck(this, ItemHight);
	...
	_createClass(ItemHight, [{
		key: 'setEqualHeight',
		value: function setEqualHeight(columns) {
			var that = this;
...
var AnimateScroll = function () {
	function AnimateScroll(name, direction, speed) {
	...
	_createClass(AnimateScroll, [{
		...
		value: function onWindowScroll() {
			...
			this.windowScrollTop = (0, _jquery2.default)(window).scrollTop();
			this.windowScrollPosBottom = this.windowHeight + this.windowScrollTop;
			(0, _jquery2.default)(window).scroll(this.animateScroll());
		}
	}, {
		key: "animateScroll",
		value: function animateScroll(name, direction, speed) {

			var that = this;

			this.name.each(function () {
				this.objectOffset = (0, _jquery2.default)(this).offset();
				...
				if (!(0, _jquery2.default)(this).hasClass("animation-complete")) {

					if (that.windowScrollPosBottom > this.objectOffsetTop) {
						(0, _jquery2.default)(this).animate({ "opacity": 1, "right": 0, "position": "fixed" }, speed).addClass("animation-complete");
					}
				}
			});
		}
